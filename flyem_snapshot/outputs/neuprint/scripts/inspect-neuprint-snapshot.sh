...
# singularity run --writable-tmpfs docker://neo4j:2026.08.1
singularity exec --writable-tmpfs docker://neo4j:2026.08.1 /scripts/_launch_snapshot_and_bash_shell.sh
