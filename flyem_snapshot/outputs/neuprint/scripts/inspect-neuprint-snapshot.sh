...
# singularity run --writable-tmpfs docker://neo4j:2026.06.0
singularity exec --writable-tmpfs docker://neo4j:2026.06.0 /scripts/_launch_snapshot_and_bash_shell.sh
